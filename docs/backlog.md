...
| BV-012 | Gruppenreservierungen planen | 1 | done | Reservierungen ab 8 Personen serverseitig als Gruppe behandeln und Anlage sowie Bearbeitung ausschließlich Inhaber/Manager erlauben; die zugeordnete Tischmenge muss exakt einer konfigurierten gültigen Kombination desselben Standorts entsprechen, während normale Reservierungen, Standortbindung und Doppelbuchungsschutz unverändert gelten (mit 142 Tests, TypeScript-Prüfung und Produktions-Build verifiziert am 23.07.2026) |
...
| BV-030 | Reservierungsstatus verwalten | 1 | done | Reguläre Reservierungen ausschließlich von `angefragt` nach `bestaetigt` oder `storniert` und von `bestaetigt` nach `storniert`, zeitgeprüftem `noShow` oder `abgeschlossen` führen; Endstatus, Blockierwirkung und manipulierte Aufrufe server- und datenbankseitig absichern sowie nur erlaubte Aktionen anzeigen (mit 145 Tests, TypeScript-Prüfung und Produktions-Build verifiziert am 23.07.2026) |
| BV-031 | Standortbindung prüfen | 1 | done | Reservierungen dürfen server- und datenbankseitig nur Tische sowie bei Gruppen exakt eine Tischkombination ihres eigenen Standorts verwenden; manipulierte Tisch-IDs und Standortwechsel mit standortfremden Zuordnungen werden vor der Doppelbuchungsprüfung abgewiesen, während die UI ausschließlich passende Tische anbietet (mit 147 Tests, TypeScript-Prüfung und Produktions-Build verifiziert am 23.07.2026) |
...
| BV-018 | Bella-Card-Rabatt anwenden | 2 | done | Offener Rechnung einen aktiven Gast als Zahler zuordnen und 15 % Bella-Card-Rabatt ausschließlich bei aktiver Bella-Card durch Inhaber/Manager anwenden; Brutto-, Rabatt- und Endbetrag ganzzahlig in Cent serverseitig bestimmen, bezahlte Rechnungen unveränderlich lassen und Zahler sowie Beträge in „Bestellungen pro Tisch“ anzeigen. Die lokale Migration `20260723150000_add_bella_card_rabatt` ist für bestehende Rechnungs- und Zahlungsdaten stabilisiert, ohne Betrags-Snapshots oder Zahlungsdaten zu verändern (mit 135 Tests, TypeScript-Prüfung, Produktions-Build, aktuellem Prisma-Migrationsstatus und Datenvergleich verifiziert am 23.07.2026). |
...
| BV-034 | Zahlungsstatus erfassen | 2 | done | Eine bestehende offene Rechnung mit unverändertem Betragssnapshot genau einmal mit Zahlungsart `bar` oder `karte` als bezahlt markieren und den Bezahlzeitpunkt speichern; Inhaber, Manager und Bedienung zulassen, Küche sowie ungültige oder manipulierte Statuswechsel sperren; Status und Zahlungsart in der Bestellansicht anzeigen (mit 129 Tests, TypeScript-Prüfung und Produktions-Build verifiziert am 23.07.2026). |
| BV-035 | Bestellung und Rechnung standortkonsistent halten | 2 | done | Bestellung, Tisch, optionale Reservierung, aufnehmender Mitarbeiter und Artikelangebot bleiben server- und datenbankseitig standortgleich; Rechnungserzeugung, Zahlerauswahl, Rabatt und Zahlung prüfen die vollständige Bestellkette erneut, manipulierte Formulardaten und direkte Schreibversuche werden abgewiesen, die UI bietet nur Daten des gewählten Standorts an (mit 150 Tests, TypeScript-Prüfung und Produktions-Build verifiziert am 24.07.2026) |
...
| BV-023 | Catering-Aufträge verwalten | 3 | done | Auftrag mit aktivem Firmenkundenkontakt, Lieferadresse, Datum, Uhrzeit, positiver Personenzahl, Menü, optionaler Notiz, centgenauem Gesamtpreis und initialem Status `angefragt` durch Inhaber/Manager anlegen und bearbeiten; serverseitig validiert, ohne Löschfunktion oder Statusfolge (mit 161 Tests, TypeScript-Prüfung und Produktions-Build verifiziert am 24.07.2026) |
